...
notify -pc config/notify-config.yaml -i output/active_urls.txt
notify -pc config/notify-config.yaml -i output/nuclei_output.txt
notify -pc config/notify-config.yaml -i output/active_ports.txt
notify -pc config/notify-config.yaml -i output/active_subdomains.txt
